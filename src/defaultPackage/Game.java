...
public class Game extends Canvas implements Runnable
{
    ...
    public Game(){
        handler = new Handler(); //creates the list of enemies
        hud = new HUD(); 
        random = new Random();
        spawn = new Spawner(handler, hud, HEIGHT, WIDTH); //starts the spawner
        
        this.addKeyListener(new KeyInput(handler));
        
        new Window(WIDTH, HEIGHT, "Bullet Heck", this, hud); //creates the windows + starts the game
        
        menu = new Menu(this); //creates the menu
